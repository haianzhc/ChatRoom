...
QLoginDialog::QLoginDialog(QWidget* parent) : QDialog(parent, Qt::WindowCloseButtonHint),
    UserLabel(this), PwdLabel(this), CaptLabel(this), UserEdit(this),
    PwdEdit(this), CaptEdit(this), LoginBtn(this), CancelBtn(this)
{
...
void QLoginDialog::paintEvent(QPaintEvent* e)
{
    ...
    for(int i = 0;i < 4;i++)
    {
        ...
        painter.drawText(180 + 20 * i,100,20,24,Qt::AlignHCenter,QString(m_captcha[i]));
    }
