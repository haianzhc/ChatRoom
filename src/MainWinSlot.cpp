...
void MainWin::onLogInOutBtnClicked()
{
    if(!m_client.isValid())
    {
...
void MainWin::LIOK_Handler(QTcpSocket&,TextMessage& message)
{
    ...
    else if(status == "kick")
    {
        ...
        QMessageBox::information(this,"警告","账号 【 " + id + "】已被封禁！");
    }
    else
    {
        setCtrlEnabled(true);
...
void MainWin::CTRL_Handler(QTcpSocket&,TextMessage& message)
{
    ...
    {
        QMessageBox::information(this,"提示","你已被管理员禁言！");
    ...
    {
        QMessageBox::information(this,"提示","账号【" + inputGrpBx.title() + "】已被封禁！");
